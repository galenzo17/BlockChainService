...
namespace BlockChainParaTodes
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("BALANCE of the minero chileno: {0}", blockChain.GetBalance(minerAddress));
            blockChain.CreateTransaction(new Transaction(user1Address, user2Address, 5));
            Console.WriteLine();
            Console.WriteLine("--------- Start mining ---------");
            blockChain.MineBlock(minerAddress);
            Console.WriteLine("BALANCE of the miner chileno: {0}", blockChain.GetBalance(minerAddress));
            Console.WriteLine();
            Console.ReadKey();
        }
